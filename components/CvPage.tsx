...
export default function CvPage() {
  ...
  useEffect(() => {
    ...
    ;['header', 'profile', 'contact', 'skills', 'formation', 'interests'].forEach(
      (id) => {
...
<style>body{font-family:Outfit,sans-serif;background:#F5F0E8;color:#3D2C29;margin:0;padding:2rem;min-height:100%}.section-body{overflow:visible!important}#cv-content,#cv-card,#cv-sidebar{border:none!important;box-shadow:none!important}</style></head>
        ...
        <div id="cv-card" className="flex flex-col lg:flex-row gap-0 overflow-hidden">
          ...
          >
            ...
            <div className="mb-8 relative">
              ...
              <ResizeHandle sectionId="skills" onResize={setSectionHeight} />
            </div>
      ...
      <div className="no-print fixed bottom-6 left-6 flex flex-col gap-2 z-30 items-start">
        ...
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2V5a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
          </svg>
          Couleurs
        </button>
        <button
